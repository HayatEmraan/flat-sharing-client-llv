...
const Notfound = () => {
  return (
    <section className="flex items-center md:col-span-3 h-full sm:p-16 dark:bg-gray-50 dark:text-gray-800 -mt-24">
      <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
        ...
        <p className="text-3xl">
          Looks like there is no flat currently available
        </p>
        <Link href={"/property"}
          rel="noopener noreferrer"
          className="px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50 border rounded-xl">
          explore more
        </Link>
      </div>
    </section>
